        ...
        // loop through the data and display it in the table
         foreach ($data as $row) {
            $output .= '<tr>
              ...
              <td>'.$row['phone'].'</td>
              <td>
              <a href="#" class="btn btn-success infoBtn" id="'.$row['id'].'" title="View User Details"> <i class="fa fa-info text-white"></i> </a>
                <a href="#"  class="btn btn-info editBtn" data-toggle="modal" data-target="#editUserModal" id="'.$row['id'].'" title="Edit User Details"><i class="fa fa-edit text-white"></i></a>
                <a href="#"   class="btn btn-danger deleteBtn" id="'.$row['id'].'" title="Delete User Information"><i class="fa fa-trash text-white"></i></a>
              </td>
